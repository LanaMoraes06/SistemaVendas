...
namespace SistemaVendas.Controllers
{
    public class CidadesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Descricao,Sigla")] Cidade cidade)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Descricao,Sigla")] Cidade cidade)
        {
            if (id != cidade.Id)
            {
                return NotFound();
